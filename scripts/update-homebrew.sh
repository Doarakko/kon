...
X86_64_DARWIN=$(shasum -a 256 "$TMP_DIR/kon-x86_64-apple-darwin.tar.gz" | awk '{print $1}')
AARCH64_DARWIN=$(shasum -a 256 "$TMP_DIR/kon-aarch64-apple-darwin.tar.gz" | awk '{print $1}')
X86_64_LINUX=$(shasum -a 256 "$TMP_DIR/kon-x86_64-unknown-linux-gnu.tar.gz" | awk '{print $1}')
...
OUTPUT_FILE="$SCRIPT_DIR/../Formula/kon.rb"
...
echo ""
echo "Done! Copy Formula/kon.rb to homebrew-tap/Formula/kon.rb"
